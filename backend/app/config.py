...
# Load .env using absolute path of backend directory
...
FORTIGATE_IP = os.getenv("FORTIGATE_IP", "10.1.1.77")
FORTIGATE_AUTH_PORT = int(os.getenv("FORTIGATE_AUTH_PORT", "443"))
